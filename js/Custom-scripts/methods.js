require(['jquery', 'materialize', 'search', 'auto', 'hammer'], function($,Velocity,search,auto){
    ...
    $('.section-input').append("<button id='submit' class='btn tooltipped red darken-1' data-position='right' data-delay='50' data-tooltip='Click Me!' onclick='search()''>Search</button>");
